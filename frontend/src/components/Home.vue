	      ...
	      <div class="container-lg">
	        <div class="row flex-center mb-5">
	          <div class="col-auto text-center my-4">
	            ...
	            <p>Some of the features and advantages that we provide for those of you <br />who are members of EmpowerHer.</p>
	          </div>
	        </div>
	        <div class="row">
	              ...
	              <div class="row flex-center">
	                ...
	                <div class="col-md-8 ps-md-3 pe-md-2 text-center text-md-start z-index-2">
	                  <div class="card-body px-0">
	                    <h4 class="card-title pt-md-5">Health Track Platform</h4>
	                    <p class="mb-0">Recognizing the importance of holistic well-being, <br class="d-none d-lg-block"> we features a health track platform <br class="d-none d-lg-block"> where women can optionally register, <br class="d-none d-lg-block"> which is useful for making it <br class="d-none d-lg-block"> easier to manage their physical and mental health. </p>
	                    <div><a class="btn btn-lg ps-0 pe-3" href="/wellness" role="button">Learn more</a>
	          ...
	          <div class="col-md-6 mb-4">
	            <div class="card px-5 px-md-3 py-lg-5">
	              <div class="row flex-center">
	                ...
	                <div class="col-md-8 ps-md-3 pe-md-2 text-center text-md-start z-index-2">
	                  <div class="card-body px-0">
	                    <h4 class="card-title pt-md-5">Resource Hub </h4>
	                    <p class="mb-0">We offers a comprehensive resource hub <br class="d-none d-lg-block"> urated with links to support organisations <br class="d-none d-lg-block"> like helplines, legal aid services <br class="d-none d-lg-block"> and sex education resources for girls <br class="d-none d-lg-block"> which would be helpfull for your well being. </p>
	                    <div><a class="btn btn-lg ps-0 pe-3" href="/sexual-awareness" role="button">Learn more</a>
	                      <svg class="bi bi-arrow-right" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#9C69E2" viewBox="0 0 16 16">
	                        <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"></path>
	                      </svg>
	                    </div>
	          ...
	          <div class="col-md-6 mb-4">
	            <div class="card px-5 px-md-3 py-lg-5">
	              <div class="row flex-center">
	                ...
	                <div class="col-md-8 ps-md-3 pe-md-2 text-center text-md-start z-index-2">
	                  <div class="card-body px-0">
	                    <h4 class="card-title pt-md-5">Story Sharing</h4>
	                    <p class="mb-0">EmpowerHer serves as a safe space <br class="d-none d-lg-block"> for survivors to share their stories, <br class="d-none d-lg-block"> ostering solidarity and empowerment among members <br class="d-none d-lg-block"> Through storytelling, we aim to break <br class="d-none d-lg-block"> the silence and stigma surrounding <br class="d-none d-lg-block">gender-based violence. </p>
	                    <div><a class="btn btn-lg ps-0 pe-3" href="/posts" role="button">Learn more</a>
	                      <svg class="bi bi-arrow-right" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#9C69E2" viewBox="0 0 16 16">
	                        <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"></path>
	                      </svg>
	                    </div>
	          ...
	          <div class="col-md-6 mb-4">
	            <div class="card px-5 px-md-3 py-lg-5">
	              <div class="row flex-center">
	                ...
	                <div class="col-md-8 ps-md-3 pe-md-2 text-center text-md-start z-index-2">
	                  <div class="card-body px-0">
	                    <h4 class="card-title pt-md-5">Safe and Inclusive Environment</h4>
	                    <p class="mb-0">We are committed to creating a safe <br class="d-none d-lg-block"> inclusive, and non-judgmental space <br class="d-none d-lg-block"> for all women and children, <br class="d-none d-lg-block"> including those from marginalised communities <br class="d-none d-lg-block">  to connect and heal<br class="d-none d-lg-block">for  every member feels valued and respected. </p>
	                    <div><a class="btn btn-lg ps-0 pe-3" href="/privacy-policy" role="button">Learn more</a>
	                      <svg class="bi bi-arrow-right" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#9C69E2" viewBox="0 0 16 16">
	                        <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"></path>
	                      </svg>
	                    </div>
	                ...
	                <div class="col-md-4 mb-3 mb-md-0">
	                  <div class="card h-100 py-3">
	                    <div class="card-body my-2">
	                      <div class="d-flex align-items-center"><img class="img-fluid me-3 me-md-2 me-lg-3" src="../assets/img/user-image.svg" width="70" alt="" />
	                        <div class="flex-1 align-items-center">
	                          <h6 class="mb-0 fs--1 text-1000 fw-medium">Anonymous User </h6>
	                          <p class="fs--2 fw-normal text-info mb-0">Anonymous</p>
	                        </div>
	                      </div>
	                      <p class="card-text ps-7 ps-md-0 ps-xl-7 pt-md-4 pt-lg-3 pt-xl-0">“Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,”.</p>
	                    </div>
	                  </div>
	                </div>
	                <div class="col-md-4 mb-3 mb-md-0">
	                  <div class="card h-100 py-3">
	                    <div class="card-body my-2">
	                      <div class="d-flex align-items-center"><img class="img-fluid me-3 me-md-2 me-lg-3" src="../assets/img/user-image.svg" width="70" alt="" />
	                        <div class="flex-1 align-items-center">
	                          <h6 class="mb-0 fs--1 text-1000 fw-medium">Marrie Doe</h6>
	                          <p class="fs--2 fw-normal text-info mb-0">User</p>
	                        </div>
	                      </div>
	                      <p class="card-text ps-7 ps-md-0 ps-xl-7 pt-md-4 pt-lg-3 pt-xl-0">“I like it because Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.”</p>
	                    </div>
	                  </div>
	                </div>
	                <div class="col-md-4 mb-3 mb-md-0">
	                  <div class="card h-100 py-3">
	                    <div class="card-body my-2">
	                      <div class="d-flex align-items-center"><img class="img-fluid me-3 me-md-2 me-lg-3" src="../assets/img/user-image.svg" width="70" alt="" />
	                        <div class="flex-1 align-items-center">
	                          <h6 class="mb-0 fs--1 text-1000 fw-medium">Chivlolet Sus</h6>
	                          <p class="fs--2 fw-normal text-info mb-0">User</p>
	                        </div>
	                      </div>
	                      <p class="card-text ps-7 ps-md-0 ps-xl-7 pt-md-4 pt-lg-3 pt-xl-0">“Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,”</p>
	                ...
	                <div class="col-md-4 mb-3 mb-md-0">
	                  <div class="card h-100 py-3">
	                    <div class="card-body my-2">
	                      <div class="d-flex align-items-center"><img class="img-fluid me-3 me-md-2 me-lg-3" src="../assets/img/user-image.svg" width="70" alt="" />
	                        <div class="flex-1 align-items-center">
	                          <h6 class="mb-0 fs--1 text-1000 fw-medium">Viezh Kai</h6>
	                          <p class="fs--2 fw-normal text-info mb-0">Kenya</p>
	                        </div>
	                      </div>
	                      <p class="card-text ps-7 ps-md-0 ps-xl-7 pt-md-4 pt-lg-3 pt-xl-0">“Wow...Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,”.</p>
	                    </div>
	                  </div>
	                </div>
	              </div>
